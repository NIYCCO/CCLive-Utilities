...
import net.felix.mixin.ChatScreenMixin;
...
public class EmojiButtonWidget extends ClickableWidget {
    ...
    public void onClick(double mouseX, double mouseY) {
        if (MinecraftClient.getInstance().currentScreen instanceof SymbolInsertable symbolInsertable) {
            symbolInsertable.insertSymbol(":" + EmojiRegistry.snippets.get(this.getMessage().getString()) + ":");
        }
    }
